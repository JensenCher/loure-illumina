        ...
        <Container>
          <div className="py-5 border-t-2 border-slate-400/50">
            ...
            <div className="flex flex-col md:flex-row md:items-stretch w-full md:gap-16">
              <div className="py-5 md:pt-5 min-w-[300px] max-w-[300px] mx-auto md:mx-5 md:max-w-[250px] md:flex md:flex-col md:justify-between md">
                <div className="flex flex-col">
                  <div className="relative pb-5 w-full">
                    <input
                      className="peer w-full h-10 rounded-xl p-3 border-b py-1 bg-slate-300 dark:bg-slate-800 text-black dark:text-white
                    ...
                    peer-placeholder-shown:text-base peer-placeholder-shown:text-slate-400 peer-placeholder-shown:top-2 
                ...
                <div className="hidden md:flex md:flex-row md:gap-4 text-slate-400">
                  ...
                  <a href="mailto: abc@example.com" title="Email">
                    <Icons.Mail className="hover:text-white transition duration-300  cursor-pointer" />
                  </a>
                </div>
              </div>
              <div className="py-5 px-5 grid grid-cols-3 md:grid-cols-4 gap-3 md:gap-14 items-start justify-between">
                <FooterCol
                  title={"Resources"}
                  links={[
                    {
